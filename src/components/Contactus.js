...
function Contactus() {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('http://localhost:8080/save',inputData)
  ...
  return (
    <>
    <div>
      <section class= "bg-green-100" text-black id="contact">
        ...
        <div class="flex items-stretch justify-center ">
            <div class="grid md:grid-cols-2 ">
                    ...
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4 mt-3" >
                                <Link  class=" mb-2 text-lg font-medium leading-6 text-gray-800 dark:text-white " to="https://maps.app.goo.gl/BsKA44sKKCS6GrPi8" >123 Anywhere St., Any City
                                </Link>
                                
                                {/* <p class="text-gray-600 dark:text-white">पोस्ट - सुखेड, लोणंद-खंडाळा रोड, पडळकर वस्ती</p> */}
                                {/* <p class="text-gray-600 dark:text-white">महाराष्ट्र, भारत</p> */}
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50 mt-4">
                            ...
                            <div class="ml-4 mb-4 ">
                                <h3 class="mb-2 text-lg font-medium leading-6 text-gray-800 dark:text-white">Contact us
                                </h3>
                                <a href="tel:9096307463" className='text-gray-800'>+123-456-7890 </a><br/><br/>
                                {/* <a href="tel:9545034747">1234567890 </a> */}
                        ...
                        <li class="flex ">
                            ...
                            <div class="ml-4 mb-4">
                                <h3 class="mb-2 text-lg font-medium leading-6 text-gray-800 dark:text-white">visiting hours
                                    </h3>
                ...
                <div class="card h-fit max-w-6xl p-5 md:p-12" id="form">
                    ...
                    <p class="text-xl font-semibold uppercase tracking-wide text-blue-600 dark:text-blue-200 mb-10 ml-44  ">
                Contact US
                </p>
...
<section class="bg-gray-900">
      ...
      <div class="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12 sm:mt-0">
        ...
        <form action="#" class="space-y-4">
          ...
          <div class="mt-4 flex  justify-center items-center ">
            ...
            {/* <p className='ml-10 '><span className='text-red-600 text-2xl  ml-4'>*</span> <span className='text-1xl '></span></p><span></span> */}
          </div>
  ...
  <div>
        ...
        <div className="mt-2 flex flex-col sm:flex-row ml-96    ">
              ...
              <Link to="/"><button  className="m-1.5 py-2.5 px-5 rounded-md border-2 border-teal-400 text-white font-semibold uppercase hover:text-black hover:border-blue-500 hover:text:green bg-blue-400 ">PRIVACY POLICIES</button></Link> 
            </div>
    </div>
