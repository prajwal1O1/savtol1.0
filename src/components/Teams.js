...
export default function Teams() {
  return (
    <section className="my-8  bg-neutral-200 mb-0 mt-0 ">
	<div className="container mx-auto flex flex-col items-left pb-6 mb-1 md:p-10 md:px-12  ">
		<h1 className="text-3xl font-semibold leading-none  text-black">Teams</h1>
	</div>
	<div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2 rounded-sm ">
		<div className="flex flex-col items-center mx-12 lg:mx-0 rounded-3xl border-2  border-indigo-60 mt-10 bg-teal-100 ">
...
Areas of Specialization:<br></br>
Professional Achievements:<br></br>
